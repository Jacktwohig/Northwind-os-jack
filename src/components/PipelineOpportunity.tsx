...
export default function PipelineOpportunity() {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-xl p-5 shadow-card border border-slate-700 flex flex-col justify-between text-white">
      ...
      <div className="space-y-2 mb-5">
        <div className="flex items-center justify-between py-2 border-t border-slate-700">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-slate-300">Qualified leads</span>
          </div>
          <div className="text-right">
            <span className="text-xs font-semibold text-white">
              {formatCurrency(pipeline.qualifiedMonthlyRevenue, true)}/mo
            </span>
            <span className="text-xs text-slate-500 ml-1">({pipeline.qualifiedCount})</span>
          </div>
        </div>
        {hotCount > 0 && (
          <div className="flex items-center justify-between py-2 border-t border-slate-700">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-slate-300">Hot inquiries</span>
            </div>
        ...
        <div className="flex items-center justify-between py-2 border-t border-slate-700">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-slate-300">Avg rate used</span>
          </div>
